const StarRatingGenerator = typeof StarRatingGenerator == "undefined" ? 0x0 : StarRatingGenerator + 0x1;
(function (_0x2292f9) {
  if (_0x2292f9 === 0x0 && !document.querySelector("script[src=\"https://www.gstatic.com/firebasejs/8.1.1/firebase-database.js\"]")) {
    ...
    _0x1fde4d.onload = function () {
      ...
      _0x164754.src = "https://www.gstatic.com/firebasejs/8.1.1/firebase-database.js";
      document.head.appendChild(_0x164754);
    };
    let _0x499ff6 = document.createElement("style");
    _0x499ff6.innerHTML = "@keyframes dawaj {0% {transform: rotate(0deg);} 100% {transform:rotate(360deg);}} .kozyr-SRS-loader ~ div{visibility:hidden;}";
    ...
    for (let _0x55d48e = 0x0; _0x55d48e < _0x1c7d22.length; _0x55d48e++) {
      if (_0x55d48e <= _0x3b1b6e) {
        if (_0x55d48e < Math.floor(_0x3b1b6e)) {
          ...
          _0x5bd454.querySelector("empty").style.width = _0x4c6b0c - _0x17e08f + "px";
          _0x5bd454.querySelector("empty").querySelector("img").style.margin = "0 0 0 -" + _0x17e08f + "px";
        }
        ...
        _0x1c7d22[_0x55d48e].querySelector("empty").querySelector("img").style.margin = "0 0 0 0";
      }
  ...
  function _0x974e9e(_0x9ce11c, _0x395cf9, _0x2ffed1) {
    ...
    _0x593d85.style.fontFamily = "'Palatino Linotype', 'Book Antiqua', Palatino, serif";
    ...
    setTimeout(function () {
      ...
      if (_0x395cf9.style.textAlign === "right") {
        _0x593d85.style.left = window.scrollX + _0x116727.left + _0x395cf9.offsetWidth - 0xc8 + "px";
      } else if (_0x395cf9.style.textAlign === "center") {
        _0x593d85.style.left = window.scrollX + _0x116727.left + _0x395cf9.offsetWidth / 0x2 - 0x64 + "px";
      } else {
        _0x593d85.style.left = window.scrollX + _0x116727.left + "px";
      }
      _0x593d85.style.top = (_0x116727.top > _0x593d85.offsetHeight ? window.scrollY + _0x116727.top - _0x593d85.offsetHeight : window.scrollY + _0x116727.top + _0x593d85.offsetHeight) + "px";
    }, 0xa);
    setTimeout(function () {
      _0x593d85.style.opacity = "0";
      setTimeout(function () {
  ...
  function _0x44b558(_0x3bc1b1) {
    ...
    if (!_0x27114b || _0x27114b === "auto") {
      let _0x1b3097 = location.href.split("?")[0x0].split("#")[0x0].replace(location.protocol + "//", "").replace("www.", "");
      if (_0x1b3097.substring(_0x1b3097.length - 0x1) === "/" || _0x1b3097.substring(_0x1b3097.length - 0x1) === ".") {
        _0x1b3097 = _0x1b3097.substring(0x0, _0x1b3097.length - 0x1);
      }
      _0x1b3097 = _0x1b3097.replace(/\./g, "_").replace(/\//g, "__").replace(/\,/g, "___").replace(/\s/g, "");
      _0x27114b = _0x1b3097;
    }
    _0x27114b = _0x27114b.replace(/\s/g, "_").replace(/\#/g, "-").replace(/\./g, "-").replace(/\@/g, "-").replace(/\!/g, "-").replace(/\$/g, "-").replace(/\%/g, "-").replace(/\&/g, "-").replace(/\(/g, "-").replace(/\)/g, "-");
    let _0x16c422 = _0x58bcd1.getAttribute("emptyStarImg") ? _0x58bcd1.getAttribute("emptyStarImg") : "https://1.bp.blogspot.com/-pOr9XGwtSJc/Wsjf8ULOIqI/AAAAAAAAAKE/KBh-LUDIn0YzASKf-t7mQo8UNpdHhr2SgCLcBGAs/s1600/pusta.png";
    let _0x38a5a0 = _0x58bcd1.getAttribute("fullStarImg") ? _0x58bcd1.getAttribute("fullStarImg") : "https://3.bp.blogspot.com/-QSNdWP4Ijx4/Wsjf7QOUZ4I/AAAAAAAAAJ8/F2nReVG5WfA1rLV3dGcAFMsPOnIQck4YwCLcBGAs/s1600/pelna.png";
    ...
    if (_0x580744 === null) {
      _0x580744 = "You have already cast your vote, your rating is $userRating$.";
    }
    ...
    let _0x3ecbbe = _0x58bcd1.getAttribute("textColor") ? _0x58bcd1.getAttribute("textColor") : "inherit";
    let _0xf196b1 = _0x58bcd1.getAttribute("fontFamily");
    if (_0xf196b1 == "Georgia" || _0xf196b1 == "Georgia, serif") {
      _0xf196b1 = "Georgia, serif";
    } else {
      if (_0xf196b1 == "Palatino" || _0xf196b1 == "'Palatino Linotype', 'Book Antiqua', Palatino, serif") {
        _0xf196b1 = "\"Palatino Linotype\", \"Book Antiqua\", Palatino, serif";
      } else {
        if (_0xf196b1 == "Times New Roman" || _0xf196b1 == "'Times New Roman', Times, serif") {
          _0xf196b1 = "\"Times New Roman\", Times, serif";
        } else {
          if (_0xf196b1 == "Arial" || _0xf196b1 == "Arial, Helvetica, sans-serif") {
            _0xf196b1 = "Arial, Helvetica, sans-serif";
          } else {
            if (_0xf196b1 == "Arial Black" || _0xf196b1 == "'Arial Black', Gadget, sans-serif") {
              _0xf196b1 = "\"Arial Black\", Gadget, sans-serif";
            } else {
              if (_0xf196b1 == "Comic Sans" || _0xf196b1 == "'Comic Sans MS', cursive, sans-serif") {
                _0xf196b1 = "\"Comic Sans MS\", cursive, sans-serif";
              } else {
                if (_0xf196b1 == "Impact" || _0xf196b1 == "Impact, Charcoal, sans-serif") {
                  _0xf196b1 = "Impact, Charcoal, sans-serif";
                } else {
                  if (_0xf196b1 == "Lucida Sans" || _0xf196b1 == "'Lucida Sans Unicode', 'Lucida Grande', sans-serif") {
                    _0xf196b1 = "\"Lucida Sans Unicode\", \"Lucida Grande\", sans-serif";
                  } else {
                    if (_0xf196b1 == "Tahoma" || _0xf196b1 == "Tahoma, Geneva, sans-serif") {
                      _0xf196b1 = "Tahoma, Geneva, sans-serif";
                    } else {
                      if (_0xf196b1 == "Trebuchet" || _0xf196b1 == "'Trebuchet MS', Helvetica, sans-serif") {
                        _0xf196b1 = "\"Trebuchet MS\", Helvetica, sans-serif";
                      } else {
                        if (_0xf196b1 == "Verdana" || _0xf196b1 == "Verdana, Geneva, sans-serif") {
                          _0xf196b1 = "Verdana, Geneva, sans-serif";
                        } else {
                          if (_0xf196b1 == "Courier New" || _0xf196b1 == "'Courier New', Courier, monospace") {
                            _0xf196b1 = "\"Courier New\", Courier, monospace";
                          } else if (_0xf196b1 == "Lucida Console" || _0xf196b1 == "'Lucida Console', Monaco, monospace") {
    ...
    let _0x34a28a = _0x58bcd1.getAttribute("topText") !== null ? _0x58bcd1.getAttribute("topText") : "Rating:";
    let _0x2ba1ad = _0x58bcd1.getAttribute("bottomText") !== null ? _0x58bcd1.getAttribute("bottomText") : "Average: <b>$average$</b> / $max$ (<b>$votes$</b> votes)";
    let _0x39df01 = Number(_0x58bcd1.getAttribute("numberOfStars"));
    if (_0x39df01 < 0x1 || isNaN(_0x39df01)) {
      _0x39df01 = 0x5;
    }
    let _0x137f57 = _0x58bcd1.getAttribute("thankYouText") !== null ? _0x58bcd1.getAttribute("thankYouText") : "Thanks for voting";
    ...
    if (_0xe6cb5e === "center") {
      ...
      _0x4556e7.style.marginLeft = "calc(100% - " + _0x2a37ea * _0x39df01 + "px)";
    }
    _0x5b42f7.appendChild(_0x4556e7);
    let _0x48f72d = document.createElement("div");
    let _0x53e55b = document.createElement("div");
    _0x2ba1ad = _0x2ba1ad.replace(/\$average\$/g, "<span class=\"kozyr-SRS-average\">0</span>").replace(/\$votes\$/g, "<span class=\"kozyr-SRS-votes\">0</span>").replace(/\$max\$/g, _0x39df01);
    ...
    if (_0x476024 === null) {
      _0x476024 = "Firebase error. Add attribute firebaseURL=\"https://YOUR-FIREBASE.firebaseio.com\" to your rating script.";
    } else {
      if (_0x476024 == "") {
        _0x476024 = "Firebase error. Enter the URL adress of your Firebase to \"firebaseURL\" attribute in your rating script.";
      } else {
    ...
    for (let _0x33f44a = 0x1; _0x33f44a <= _0x39df01; _0x33f44a++) {
      ...
      _0x59ecc2.style.cursor = !localStorage["bsrgl_" + _0x27114b] && !_0x1d2a25 ? "pointer" : "default";
      if (!_0x1d2a25) {
        _0x59ecc2.onmouseenter = function () {
          if (!localStorage["bsrgl_" + _0x27114b]) {
            let _0x3d1622 = _0x5b42f7.getElementsByTagName("SRSstar");
            for (let _0x405a32 = 0x0; _0x405a32 < _0x3d1622.length; _0x405a32++) {
              if (_0x405a32 < _0x33f44a) {
                ...
                _0x3d1622[_0x405a32].querySelector("hover").style.width = "100%";
              } else {
                _0x3d1622[_0x405a32].querySelector("full").style.width = "0%";
                _0x3d1622[_0x405a32].querySelector("hover").style.width = "0%";
                _0x3d1622[_0x405a32].querySelector("empty").style.width = "100%";
                _0x3d1622[_0x405a32].querySelector("empty").querySelector("img").style.margin = "0 0 0 0";
              }
            }
            if (_0x34a28a != "") {
            ...
            _0x5b42f7.title = _0x580744.replace(/\$userRating\$/g, localStorage["bsrgl_" + _0x27114b]);
    ...
    if (_0x476024.indexOf("Firebase error") < 0x0) {
      ...
      let _0x1d4f1f = _0x34428f.database().ref("StarRatingSystem/" + _0x4a2f7c + "/" + _0x27114b);
      _0x1d4f1f.on("value", _0x3a4f82 => {
        ...
        _0x5b42f7.querySelectorAll(".kozyr-SRS-average").forEach(_0x402b7f => _0x402b7f.textContent = Math.round(_0x16c0cc.OO * _0x39df01 * 0x64) / 0x64);
        _0x5b42f7.querySelectorAll(".kozyr-SRS-votes").forEach(_0x38e051 => _0x38e051.textContent = _0x16c0cc.O0);
        if (!_0x1d2a25) {
          _0x5b42f7.querySelectorAll("SRSstar").forEach((_0x37b286, _0x5c4fa2) => {
            _0x37b286.onclick = function () {
              if (!localStorage["bsrgl_" + _0x27114b]) {
                ...
                _0x5b42f7.querySelectorAll("SRSstar").forEach(_0x336e73 => _0x336e73.style.cursor = "default");
                _0x974e9e(_0x137f57, _0x5b42f7, _0x5c4fa2 + 0x1);
                _0x48f72d.innerHTML = _0x34a28a;
              } else {
                _0x974e9e(_0x580744, _0x5b42f7, localStorage["bsrgl_" + _0x27114b]);
              }
            };
          });
        }
