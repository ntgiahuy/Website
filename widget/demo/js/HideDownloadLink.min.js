...
if("enclosure"==t.entry.link[e].rel&&"text/html"==t.entry.link[e].type){var n=t.entry.link[e].href;localStorage.setItem("download_link",n)}}});setTimeout(function(){window.open('/p/download.html','_blank');},1e3)});
//]]>
