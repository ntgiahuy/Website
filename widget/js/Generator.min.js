...
function getButton(){
  ...
  if (-1 != drive) {
    ...
    document.getElementById("driveID").value = "Url không đúng với định dạng";
  }
}
function copy(){
