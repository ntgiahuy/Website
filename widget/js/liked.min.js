if (giahuyLike.sharedBy === 'www.giahuy.net') {
    ...
    function getLiked() {
        ...
        const firebaseUrl = `${giahuyLike.firebaseUrl}${document.querySelector('.gh-like-btn').getAttribute('data-like')}`;
