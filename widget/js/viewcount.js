...
(function () {
  ...
  const initFirebase = (callback) => {
    ...
    loadScript("https://www.gstatic.com/firebasejs/8.10.1/firebase-app.js", "firebase-app", () => {
      loadScript("https://www.gstatic.com/firebasejs/8.10.1/firebase-database.js", "firebase-db", () => {
        callback();
      });
    });
  };
  ...
  if (config.lazyload) {
    ...
    document.readyState === "complete" && trigger();
  } else {
    run();
  }
})();
